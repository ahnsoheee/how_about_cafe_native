        ...
        return (
            <NavigationContainer>
                <Stack.Navigator
                    ...
                    <Stack.Screen name="Detail" component={DetailScreen} options={({ route }) => ({ title: route.params.cafe_name, headerShown: false })} />
                    ...
                    <Stack.Screen name="Image" component={ImageScreen} options={({ route }) => ({ title: route.params.cafe_name })} />
                </Stack.Navigator>
            </NavigationContainer>
        );
    }
